...
# To download the JSON key file for your service account in Google Cloud, follow these steps:

# Go to the Google Cloud Console: Log in to your Google Cloud account and navigate to the console.

# Select the Project: Choose the project that contains the service account you want to download the key for.

# Navigate to IAM & Admin: In the left-hand menu, go to IAM & Admin and then select Service Accounts.

# Find the Service Account: Locate the service account for which you want to download the key.

# Create a Key: Click on the Actions dropdown next to the service account and select Create key.

# Choose Key Type: Select JSON as the key type and click Create.

# Download the Key: The JSON key file will be downloaded to your local machine. Make sure to store it securely, as it grants access to your service account.
...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r"D:\Surya files\GCPkeys\qwiklabs-gcp-00-27256a8be47d-cfd506000491.json"
